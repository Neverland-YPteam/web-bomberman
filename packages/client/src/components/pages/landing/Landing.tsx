      ...
      <Stack alignSelf="center" spacing={4} padding={5}>
        {LandingSection('Об игре', () => (
          <div>
            ...
            <p>
              Всего в игре 20 уровней, генерируемых псевдослучайным образом.<br />
            ...
            <p>
              За выполнение различных действий вы зарабатываете очки.<br />
              Завершить уровень можно, выйдя через дверь, которая находится под одной из стен.
            </p>
            <p>
              При взрыве двери или бонуса на уровне появляются дополнительные враги.<br />
              Аналогичное наказание поджидает вас, если не уложиться в отведенное время.
            </p>
          </div>
        ))}

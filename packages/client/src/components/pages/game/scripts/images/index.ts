...
const spriteTextureCoords: TCoords = {
  ...
  [textures.TEXTURE_HERO_RIGHT_MOVING_2]:  [0, 4],
  [textures.TEXTURE_HERO_LEFT_STANDING]:   [1, 1],
  [textures.TEXTURE_HERO_LEFT_SITTING]:    [1, 2],
  [textures.TEXTURE_HERO_LEFT_MOVING_1]:   [1, 3],
  [textures.TEXTURE_HERO_LEFT_MOVING_2]:   [1, 4],
  [textures.TEXTURE_HERO_DOWN_STANDING]:   [2, 1],
  [textures.TEXTURE_HERO_DOWN_SITTING]:    [2, 2],
  [textures.TEXTURE_HERO_DOWN_MOVING_1]:   [2, 3],
  [textures.TEXTURE_HERO_DOWN_MOVING_2]:   [2, 4],
  [textures.TEXTURE_HERO_UP_STANDING]:     [3, 1],
  [textures.TEXTURE_HERO_UP_SITTING]:      [3, 2],
  [textures.TEXTURE_HERO_UP_MOVING_1]:     [3, 3],
  [textures.TEXTURE_HERO_UP_MOVING_2]:     [3, 4],

...
const spriteTextureCoords: TCoords = {
  ...
  [textures.TEXTURE_BALLOON_LEFT_3]:       [0, 6],
  [textures.TEXTURE_BALLOON_LEFT_2]:       [1, 6],
  [textures.TEXTURE_BALLOON_LEFT_1]:       [2, 6],
  [textures.TEXTURE_BALLOON_DEAD]:         [3, 6],
  [textures.TEXTURE_BALLOON_RIGHT_1]:      [4, 6],
  [textures.TEXTURE_BALLOON_RIGHT_2]:      [5, 6],
  [textures.TEXTURE_BALLOON_RIGHT_3]:      [6, 6],
  [textures.TEXTURE_BEAKER_LEFT_DEAD]:     [3, 7],
  [textures.TEXTURE_BEAKER_LEFT_1]:        [2, 7],
  [textures.TEXTURE_BEAKER_LEFT_2]:        [1, 7],
  [textures.TEXTURE_BEAKER_LEFT_3]:        [0, 7],
  [textures.TEXTURE_BEAKER_RIGHT_DEAD]:    [4, 7],
  [textures.TEXTURE_BEAKER_RIGHT_1]:       [5, 7],
  [textures.TEXTURE_BEAKER_RIGHT_2]:       [6, 7],
  [textures.TEXTURE_BEAKER_RIGHT_3]:       [7, 7],
  [textures.TEXTURE_LANTERN_LEFT_3]:       [0, 8],
  [textures.TEXTURE_LANTERN_LEFT_2]:       [1, 8],
  [textures.TEXTURE_LANTERN_LEFT_1]:       [2, 8],
  [textures.TEXTURE_LANTERN_DEAD]:         [3, 8],
  [textures.TEXTURE_LANTERN_RIGHT_1]:      [4, 8],
  [textures.TEXTURE_LANTERN_RIGHT_2]:      [5, 8],
  [textures.TEXTURE_LANTERN_RIGHT_3]:      [6, 8],
  [textures.TEXTURE_FACE_LEFT_3]:          [0, 9],
  [textures.TEXTURE_FACE_LEFT_2]:          [1, 9],
  [textures.TEXTURE_FACE_LEFT_1]:          [2, 9],
  [textures.TEXTURE_FACE_DEAD]:            [3, 9],
  [textures.TEXTURE_FACE_RIGHT_1]:         [4, 9],
  [textures.TEXTURE_FACE_RIGHT_2]:         [5, 9],
  [textures.TEXTURE_FACE_RIGHT_3]:         [6, 9],
  ...
  [textures.TEXTURE_JELLY_LEFT_DEAD]:      [3, 11],
  [textures.TEXTURE_JELLY_LEFT_1]:         [2, 11],
  [textures.TEXTURE_JELLY_LEFT_2]:         [1, 11],
  [textures.TEXTURE_JELLY_LEFT_3]:         [0, 11],
  [textures.TEXTURE_JELLY_RIGHT_DEAD]:     [4, 11],
  [textures.TEXTURE_JELLY_RIGHT_1]:        [5, 11],
  [textures.TEXTURE_JELLY_RIGHT_2]:        [6, 11],
  [textures.TEXTURE_JELLY_RIGHT_3]:        [7, 11],
  [textures.TEXTURE_BEAR_LEFT_3]:          [0, 12],
  [textures.TEXTURE_BEAR_LEFT_2]:          [1, 12],
  [textures.TEXTURE_BEAR_LEFT_1]:          [2, 12],
  [textures.TEXTURE_BEAR_DEAD]:            [3, 12],
  [textures.TEXTURE_BEAR_RIGHT_1]:         [4, 12],
  [textures.TEXTURE_BEAR_RIGHT_2]:         [5, 12],
  [textures.TEXTURE_BEAR_RIGHT_3]:         [6, 12],
  [textures.TEXTURE_COIN_DEAD]:            [2, 13],
  [textures.TEXTURE_COIN_LEFT_1]:          [1, 13],
  [textures.TEXTURE_COIN_LEFT_2]:          [0, 13],
  [textures.TEXTURE_COIN_RIGHT_1]:         [3, 13],
  [textures.TEXTURE_COIN_RIGHT_2]:         [4, 13],
  [textures.TEXTURE_COIN_SIDE]:            [5, 13],
